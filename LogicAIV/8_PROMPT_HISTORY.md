work on robust code based on prompt 1.1 from 7_PROMPT_GALLERY.md, include code comments from research 5_PHYSICS_RESEARCH.md
...
update UX and UI based on robust code from prompt 1.1 from 7_PROMPT_GALLERY.md, include code comments from research 5_PHYSICS_RESEARCH.md
